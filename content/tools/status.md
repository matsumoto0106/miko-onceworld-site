...
<div class="sim">
  ...
  <div class="row">
    <label>合計ポイント <input id="basePointTotal" type="number" inputmode="numeric" min="0" value="0" /></label>
    <div id="basePointInfo" class="note"></div>
  </div>

  <div class="grid">
    <label>vit <input id="base_vit" type="number" inputmode="numeric" min="0" value="0" /></label>
    <label>spd <input id="base_spd" type="number" inputmode="numeric" min="0" value="0" /></label>
    <label>atk <input id="base_atk" type="number" inputmode="numeric" min="0" value="0" /></label>
    <label>int <input id="base_int" type="number" inputmode="numeric" min="0" value="0" /></label>
    <label>def <input id="base_def" type="number" inputmode="numeric" min="0" value="0" /></label>
    <label>mdef <input id="base_mdef" type="number" inputmode="numeric" min="0" value="0" /></label>
    <label>luk <input id="base_luk" type="number" inputmode="numeric" min="0" value="0" /></label>
  </div>
  ...
  <div class="protein-grid">
    ...
    <label>atk <input id="protein_atk" type="number" inputmode="numeric" min="0" value="0" /></label>
    <label>int <input id="protein_int" type="number" inputmode="numeric" min="0" value="0" /></label>
    <label>def <input id="protein_def" type="number" inputmode="numeric" min="0" value="0" /></label>
    <label>mdef <input id="protein_mdef" type="number" inputmode="numeric" min="0" value="0" /></label>
  ...
  <div class="row">
    ...
    <button id="resetBtn" type="button">振り分けを0に戻す</button>
